...
// Inside your React component where you're rendering the icons:
export const RenderIcons = ({ iconName }) => {
  switch (iconName) {
    case "AiFillHome":
      return <AiFillHome />;
    case "MdLocalFireDepartment":
    ...
    case "MdLiveTv":
        return <MdLiveTv />;
    case "IoGameControllerSharp":
        return <IoGameControllerSharp />;
    case "ImNewspaper":
        return <ImNewspaper />;
    case "GiDiamondTrophy":
        return <GiDiamondTrophy />;
    case "RiLightbulbLine":
